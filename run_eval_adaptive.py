...
dataset_config['GT_FOLDER'] = '/root/autodl-tmp/LeafTrackNet-main/datasets/CanolaTrack/CanolaTrack/val'
dataset_config['TRACKERS_FOLDER'] = '/root/autodl-tmp/LeafTrackNet-main/outputs/bio_adaptive'
